...
import {
  ...
  Modal, Alert, Platform, StatusBar, BackHandler, SafeAreaView, Switch, Dimensions, PanResponder, Animated, KeyboardAvoidingView, Image
} from "react-native";
...
function useDrag(items, onReorder) {
  ...
  return { displayItems, makeHandlers, isDragging, isDragActive: dragActive };
}
