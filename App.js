...
function SettingsTab({C}) {
  ...
  const exportData = async () => {
    ...
    try {
      ...
      // Gespeicherten Ordner laden oder einmalig auswählen (1x Downloads wählen, dann nie wieder)
      ...
      try {
        ...
        setStatus({ok:true, msg:"✅ Gespeichert: " + fileName});
      } catch(dirErr) {
        await saveData("lo_backup_dir", null);
        setStatus({ok:false, msg:"❌ Ordner nicht mehr verfügbar — bitte erneut tippen."});
      }
    } catch(e) {
